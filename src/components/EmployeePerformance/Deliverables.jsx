      ...
      <div className="w-full lg:w-10/12 xl:w-9/12 mx-auto mt-2 bg-white rounded-md border border-black/90 shadow-md p-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <span className="font-semibold text-gray-700 mr-2">Dashboard</span> {/* Optional label next to the home icon */}
          </div>
          ...
          <div className="flex lg:gap-4 gap-2 items-center">
            ...
            {userRole !== 'ROLE_EMPLOYEE' && (
              <NavLink
                ...
                className="flex items-center lg:px-4 lg:py-2 lg:text-lg text-xs px-3 py-2 md:px-4 md:py-2 bg-blue-950 text-white rounded-lg hover:bg-orange-500 transition duration-300"
              >
